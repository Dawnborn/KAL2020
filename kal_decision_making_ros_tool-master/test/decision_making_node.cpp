...
// TEST(kal_decision_making_ros_tool, testDecisionMaking){
//    your test goes here
// }


// This test just ensures that the node can be launched sucessfully. You can remove this if you have a better test.
TEST(kal_decision_making_ros_tool, testDecisionMakingNodeInitialization) {
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "decision_making_test");
