 ...
 *  The cross product of (v1, v2) and (w1, w2) is be the 3rd coordinate of the cross product of (v1, v2, 0) and (w1, w2,
 * 0). This the signed area of a parallelepiped spanned by the input vector. eigen might implement this in future
 * versions: http://eigen.tuxfamily.org/bz/show_bug.cgi?id=1037 \param a the first vector \param b the second vector
